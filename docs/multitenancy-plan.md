...
1. **Bootstrap config**  
   ...
   - Introduce `TENANT_CONFIG_PATH` pointing to an encrypted YAML/JSON file storing seed tenants and credential profiles. Provide CLI: `pinguin tenants import --file tenants.yaml`.
