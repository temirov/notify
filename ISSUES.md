...
- [ ] [PN-100] Add a front-end.
  ...
  Plan tasks:
    ...
    - [ ] PN-100.J — Simulate full landing sign-in handshake in tests (nonce fetch, Google credential callback, `/auth/google` exchange) to prove the Alpine auth controller’s happy path.
